...
function cards() {
    ...
    // 2 способ создания карточек без шалонизации и конструкторов
...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            e.preventDefault(); // отмена перезагрузки браузера
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    dots.forEach(dot => {
        dot.addEventListener('click', (e) => {
            ...
            slideIndex = slideTo;
            offset = delLetters(width) * (slideTo - 1);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_0__["default"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabhead__item_active');
